            ...
            {isCollapsed ? (
              <Tooltip key="logout" delayDuration={0}>
                <TooltipTrigger asChild>
                  <Link
                    ...
                    className={cn(
                      buttonVariants({
                        variant: pathName.startsWith(logoutLink.href) ? "default" : "ghost",
                        size: "icon"
                      }),
                      "h-10 w-10",
                      pathName.startsWith(logoutLink.href) && "text-white bg-[#F9802D]",
                      logoutLink.variant === "default" &&
                        "dark:bg-muted dark:text-muted-foreground dark:hover:bg-muted dark:hover:text-white"
                    )}
                  >
              ...
              <Link
                ...
                className={cn(
                  ...
                  pathName.startsWith(logoutLink.href) && "text-white bg-primary",
