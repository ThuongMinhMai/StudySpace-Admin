...
//   return (
//     <CardContent className='border-[0.5px] border-orange-400 bg-orange-200/40 shadow-orange-400'>
//       <section className='flex justify-between gap-2 '>
//         {/* label */}
//         <p className='text-sm font-bold text-orange-400'>{props.label}</p>
//         {/* icon */}
//         <props.icon className='h-6 w-6 text-orange-500' />
//       </section>
//       <section className='flex items-center gap-5'>
//         <h2 className='text-2xl font-semibold text-orange-700'>{props.amount}</h2>
